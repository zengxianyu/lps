...
def print_table():
    ...
    # algs = ['LEGS', 'RFCN', 'DCL', 'DHS', 'MCDL', 'MDF']
    algs = ['Ours-Seg', 'Ours-Seg-woSeg', 'Ours-N1-Seg', 'Ours-N1-Seg-woSeg']
    # datasets = ['ECSSD', 'PASCALS', 'SOD', 'MSRA5K', 'OMRON']
    datasets = ['ECSSD']
    for alg in algs:
        print(alg+'& ', end='')
...
def draw_curves():
    base_dir = '/home/zeng/data/datasets/saliency_Dataset'
    algs = ['BSCA', 'MR', 'HS', 'Ours', 'WSS', 'DRFI', 'LEGS', 'MCDL', 'MDF']
    datasets = ['ECSSD', 'PASCALS', 'SOD', 'OMRON']
...
def fm_and_mae(input_dir, gt_dir, output_dir=None, name=None):
    ...
    return thfm, m_mea, m_recs, m_pres


if __name__ == '__main__':
    # fm, mae, _, _ = fm_and_mae('/home/zeng/data/datasets/saliency_Dataset/results/ECSSD-Sal/WSS',
    #                      '/home/zeng/data/datasets/saliency_Dataset/ECSSD/masks')
    # print(fm)
    # print(mae)
    print_table()
    # draw_curves()
